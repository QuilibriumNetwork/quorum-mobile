...
- 🐛 [Space mention notifications bake names at write time, so a `.q` never renders there](issues/.done/2026-08-14-space-mention-notifications-bake-names-at-write-time-so-no-q-ever-renders.md)
